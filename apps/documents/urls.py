...
urlpatterns = patterns('documents.views',
    ...
    url(r'^create/from/local/multiple-csv/$', 'document_create', {'csv': True}, 'document_create_multiple_csv'),
    ...
    url(r'^multiple/export_all/$', 'document_export_csv_all', (), 'document_export_csv_all'),
    url(r'^multiple/export/$', 'document_export_csv_selected', (), 'document_export_csv_selected'),
